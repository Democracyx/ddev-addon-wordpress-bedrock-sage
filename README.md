...
[![tests](https://github.com/ddev/ddev-ddev-addon-wordpress-bedrock-sage/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/ddev/ddev-ddev-addon-wordpress-bedrock-sage/actions/workflows/tests.yml?query=branch%3Amain)
[![last commit](https://img.shields.io/github/last-commit/ddev/ddev-ddev-addon-wordpress-bedrock-sage)](https://github.com/ddev/ddev-ddev-addon-wordpress-bedrock-sage/commits)
[![release](https://img.shields.io/github/v/release/ddev/ddev-ddev-addon-wordpress-bedrock-sage)](https://github.com/ddev/ddev-ddev-addon-wordpress-bedrock-sage/releases/latest)
...
* The fundamental contents of the add-on service or other component. For example, in this template there is a [docker-compose.ddev-addon-wordpress-bedrock-sage.yaml](docker-compose.ddev-addon-wordpress-bedrock-sage.yaml) file.
...
3. Globally replace "ddev-addon-wordpress-bedrock-sage" with the name of your add-on.
4. Add the files that need to be added to a DDEV project to the repository. For example, you might replace `docker-compose.ddev-addon-wordpress-bedrock-sage.yaml` with the `docker-compose.*.yaml` for your recipe.
